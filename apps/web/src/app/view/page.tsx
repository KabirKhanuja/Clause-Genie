...
import DocSummaryPanel from "../components/SummaryPanel";
      ...
      <main className="px-6 py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3 space-y-4">
            <div className="rounded-2xl bg-[#081226]/70 border border-slate-700 p-4">
              <DocSummaryPanel sessionId={sessionId} />
            </div>
